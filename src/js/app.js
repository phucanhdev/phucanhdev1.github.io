...
const list_music = [
    {
        ...
        'img': '../img/music/ff1.jpg'
    },
    {
        'name': 'Phúc Anh 2',
        'author': 'Phúc Anh',
        'src': './src/music/y2mate.com - Vương Vấn x Chưa Chắc Đã Giống Đâu Beat Remix  Nhạc Hot Tik Tok 2022.mp3',
        'img': '../img/music/ff2.jpg'
];   },
     {
        'name': "Phúc Anh 3",
        'author': 'Phúc Anh',
        'src': './src/music/3107 2 Remix  Chỉ cần ai đó cạnh bên dừng lại  Nhạc Hot Tiktok hay nhất 2022.mp3',
        'img': '../img/music/ff3.jpg'
